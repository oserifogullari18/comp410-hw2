...
const int NumVertices =
    36; //(6 faces)(2 triangles/face)(3 vertices/triangle)(27 cube)
const int numCubes =
    27; //(6 faces)(2 triangles/face)(3 vertices/triangle)(27 cube)
...
void quad(int a, int b, int c, int d, int color, int cube_index) {
  Cubes[cube_index].colors[Index] = vertex_colors[color];
  Cubes[cube_index].points[Index] = vertices[a];
  Index++;
  Cubes[cube_index].colors[Index] = vertex_colors[color];
  Cubes[cube_index].points[Index] = vertices[b];
  Index++;
  Cubes[cube_index].colors[Index] = vertex_colors[color];
  Cubes[cube_index].points[Index] = vertices[c];
  Index++;
  Cubes[cube_index].colors[Index] = vertex_colors[color];
  Cubes[cube_index].points[Index] = vertices[a];
  Index++;
  ...
  Index++;
  Cubes[cube_index].colors[Index] = vertex_colors[color];
  Cubes[cube_index].points[Index] = vertices[d];
  Index++;
}
...
void colorcube() {
  ...
  for (int i = 0; i < numCubes; i++) {
    Index = 0;
    offset = offset * i;
    quad(offset + 1, offset + 0, offset + 3, offset + 2, 1, i);
    quad(offset + 2, offset + 3, offset + 7, offset + 6, 0, i);
    quad(offset + 3, offset + 0, offset + 4, offset + 7, 3, i);
    quad(offset + 6, offset + 5, offset + 1, offset + 2, 0, i);
    quad(offset + 4, offset + 5, offset + 6, offset + 7, 0, i);
    quad(offset + 5, offset + 4, offset + 0, offset + 1, 5, i);
  }
...
void init() {
  ...
  mat4 projection;
  projection = Perspective(45.0f, 1.0, 0.1,
                           100.0); // Ortho(): user-defined function in mat.h
...
void translateVertices(GLfloat *vertices, GLfloat *newVertices, float xAmount,
                       float yAmount, float zAmount, int vertexAttributeNumber,
                       int iterationNumber) {
